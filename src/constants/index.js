...
export const HERO_CONTENT = `Software Engineer with 3+ years of experience building fast and reliable applications across web and native platforms. Skilled in C++, Python, Java, and JavaScript with expertise in React.js, focusing on clean code, scalable architecture, and efficient problem-solving across the stack. I aim to build high-performance systems that deliver real-world impact and seamless user experiences.`;

export const ABOUT_TEXT = `I am a Software Engineer driven by a strong foundation in data structures, algorithms, and system design. With experience across web and native platforms, I have worked with technologies like C++, Python, Java, JavaScript, and React.js to build efficient and scalable applications. I focus on writing clean, maintainable code and solving complex engineering problems with practical, performance-oriented approaches. I enjoy working across the stack, optimizing systems, and contributing to end-to-end product development. I thrive in collaborative environments, continuously learn new technologies, and take ownership of delivering impactful solutions. Outside of work, I spend time improving problem-solving skills, exploring system design concepts, and building projects that push my technical boundaries.`;
